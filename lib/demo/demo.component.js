...
var DemoApp = exports.DemoApp = (_dec = (0, _core.Component)({
    ...
    function DemoApp(chomsky) {
        ...
        this.currentLanguage = this.usLocale;
        ...
        // Set Language to ES
        this.chomsky.setLanguage(this.frLocale);
